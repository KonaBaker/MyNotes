...
只能绑定depth format的格式。成为depth buffer(The image attached becomes the **Depth Buffer** for the FBO.)。如果没有attach将禁用深度测试。

- `GL_STENCIL_ATTACHMENT`

模板格式。成为stencil buffer.(The image attached becomes the **stencil buffer** for the FBO.)
